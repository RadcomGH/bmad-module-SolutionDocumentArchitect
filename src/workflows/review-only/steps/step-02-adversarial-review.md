...
The Review Board will now examine your document. Expect rigorous challenge—this is how we make documents bulletproof."
...
**High Priority:** {count} — Should fix for better customer reception
{list}

**Medium Priority:** {count} — Nice to improve
{list}
...
**High Priority:** {count} — Should fix (technical gaps, alignment issues)
{list}

**Medium Priority:** {count} — Consider improving
{list}
...
- 🟠 **High priority:** {count} — Should fix before publication
- 🟡 **Medium priority:** {count} — Would improve quality
...
✅ Document reviewed from customer perspective (if included)
✅ Document reviewed from R&D perspective (if included)
